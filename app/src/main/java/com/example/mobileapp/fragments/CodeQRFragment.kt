 ...
 * Use the [CodeQRFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CodeQRFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_code_q_r, container, false)
        return view
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        reservationsViewModel.reservation.observe(this) { reservation ->
            if (reservation != null) {
